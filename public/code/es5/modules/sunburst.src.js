...
var TreemapSeries = /** @class */ (function (_super) {
    ...
    TreemapSeries.prototype.calculateChildrenAreas = function (parent, area) {
        var series = this, options = series.options, mapOptionsToLevel = series.mapOptionsToLevel, level = mapOptionsToLevel[parent.level + 1], algorithm = TreemapSeries_pick((series[(level && level.layoutAlgorithm)] &&
    ...
    TreemapSeries.prototype.getListOfParents = function (data, existingIds) {
        var arr = TreemapSeries_isArray(data) ? data : [], ids = TreemapSeries_isArray(existingIds) ? existingIds : [], listOfParents = arr.reduce(function (prev, curr, i) {
    ...
    TreemapSeries.prototype.init = function (chart, options) {
        var series = this, breadcrumbsOptions = TreemapSeries_merge(options.drillUpButton, options.breadcrumbs), setOptionsEvent = TreemapSeries_addEvent(series, 'setOptions', function (event) {
    ...
    TreemapSeries.prototype.pointAttribs = function (point, state) {
        var series = this, mapOptionsToLevel = (TreemapSeries_isObject(series.mapOptionsToLevel) ?
    ...
    TreemapSeries.prototype.setRootNode = function (id, redraw, eventArguments) {
        var series = this, eventArgs = TreemapSeries_extend({
            newRootId: id,
    ...
    TreemapSeries.prototype.setTreeValues = function (tree) {
        ...
        // Set the values
        var val = TreemapSeries_pick(point && point.options.value, childrenTotal);
        if (point) {
            point.value = val;
        }
...
function getDlOptions(params) {
    var _a;
    // Set options to new object to avoid problems with scope
    var point = params.point, shape = SunburstSeries_isObject(params.shapeArgs) ? params.shapeArgs : {}, optionsPoint = (SunburstSeries_isObject(params.optionsPoint) ?
...
function cbSetTreeValuesBefore(node, options) {
    var mapIdToNode = options.mapIdToNode, parent = node.parent, nodeParent = parent ? mapIdToNode[parent] : void 0, series = options.series, chart = series.chart, points = series.points, point = points[node.i], colors = series.options.colors || chart && chart.options.colors, colorInfo = SunburstSeries_getColor(node, {
        colors: colors,
...
var SunburstSeries = /** @class */ (function (_super) {
    ...
    SunburstSeries.prototype.translate = function () {
        ...
        var idTop = SunburstSeries_isString(nodeRoot.parent) ? nodeRoot.parent : '', nodeTop = mapIdToNode[idTop], _a = Sunburst_SunburstUtilities.getLevelFromAndTo(nodeRoot), from = _a.from, to = _a.to;
