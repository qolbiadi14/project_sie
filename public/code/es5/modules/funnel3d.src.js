...
function rendererFunnel3dPath(shapeArgs) {
    ...
    var renderer = this, chart = Funnel3DComposition_charts[renderer.chartIndex], 
...
var Funnel3DSeries = /** @class */ (function (_super) {
    ...
    Funnel3DSeries.prototype.alignDataLabel = function (point, _dataLabel, options) {
        var series = this, dlBoxRaw = point.dlBoxRaw, inverted = series.chart.inverted, below = point.plotY > Funnel3DSeries_pick(series.translatedThreshold, series.yAxis.len), inside = Funnel3DSeries_pick(options.inside, !!series.options.stacking), dlBox = {
            x: dlBoxRaw.x,
            y: dlBoxRaw.y,
            height: 0
        };
