...
var DOMElementProvider = /** @class */ (function () {
    ...
    DOMElementProvider.prototype.createElement = function () {
        var el = DOMElementProvider_doc.createElement.apply(DOMElementProvider_doc, arguments);
...
var EventProvider = /** @class */ (function () {
    ...
    EventProvider.prototype.addEvent = function () {
        var remover = addEvent.apply((highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default()), arguments);
...
var KeyboardNavigationHandler = /** @class */ (function () {
    ...
    KeyboardNavigationHandler.prototype.run = function (e) {
        ...
        var handlerCodeSet = KeyboardNavigationHandler_find(this.keyCodeMap, function (codeSet) {
...
(function (FocusBorderComposition) {
    ...
    function svgElementAddFocusBorder(margin, attribs) {
        ...
        // Add the border rect
        var bb = this.getBBox(), pad = FocusBorder_pick(margin, 3), parent = this.parentGroup, scaleX = this.scaleX || parent && parent.scaleX, scaleY = this.scaleY || parent && parent.scaleY, oneDefined = scaleX ? !scaleY : scaleY, scaleBoth = oneDefined ? Math.abs(scaleX || scaleY || 1) :
...
var Announcer = /** @class */ (function () {
    ...
    Announcer.prototype.createAnnouncerContainer = function () {
        var chart = this.chart, container = Announcer_doc.createElement('div');
        attr(container, {
            'aria-hidden': false,
...
function getAnnotationListItems(chart) {
    ...
    return labels.map(function (label) {
        var desc = AnnotationsA11y_escapeStringForHTML(AnnotationsA11y_stripHTMLTagsFromString(getAnnotationLabelDescription(label), chart.renderer.forExport));
...
var InfoRegionsComponent = /** @class */ (function (_super) {
    ...
    InfoRegionsComponent.prototype.getLinkedDescriptionElement = function () {
        ...
        var query = InfoRegionsComponent_format(linkedDescOption, this.chart), queryMatch = InfoRegionsComponent_doc.querySelectorAll(query);
    ...
    InfoRegionsComponent.prototype.getDataTableButtonText = function (buttonId) {
        var chart = this.chart, buttonText = chart.langFormat('accessibility.table.viewAsDataTableButtonText', { chart: chart, chartTitle: InfoRegionsComponent_getChartTitle(chart) });
    ...
    InfoRegionsComponent.prototype.getSonifyButtonText = function (buttonId) {
        ...
        var buttonText = chart.langFormat('accessibility.sonification.playAsSoundButtonText', { chart: chart, chartTitle: InfoRegionsComponent_getChartTitle(chart) });
        return '<button id="' + buttonId + '">' + buttonText + '</button>';
    };
    /**
     * @private
    ...
    InfoRegionsComponent.prototype.getEndOfChartMarkerText = function () {
        var endMarkerId = "highcharts-end-of-chart-marker-".concat(this.chart.index), endMarker = InfoRegionsComponent_getElement(endMarkerId);
        if (endMarker) {
...
var KeyboardNavigation = /** @class */ (function () {
    ...
    KeyboardNavigation.prototype.updateExitAnchor = function () {
        var endMarkerId = "highcharts-end-of-chart-marker-".concat(this.chart.index), endMarker = KeyboardNavigation_getElement(endMarkerId);
        this.removeExitAnchor();
        if (endMarker) {
    ...
    KeyboardNavigation.prototype.onKeydown = function (ev) {
        var e = ev || KeyboardNavigation_win.event, curNavModule = (this.modules &&
            this.modules.length &&
    ...
    KeyboardNavigation.prototype.createExitAnchor = function () {
        var chart = this.chart, exitAnchor = this.exitAnchor = KeyboardNavigation_doc.createElement('div');
    ...
    KeyboardNavigation.prototype.addExitAnchorEventsToEl = function (element) {
        ...
        this.eventProvider.addEvent(element, 'focus', function (ev) {
            var e = ev || KeyboardNavigation_win.event, focusComesFromChart = (e.relatedTarget &&
            ...
            [0, 1].forEach(function (n) {
                ...
                if (handle) {
                    var proxyEl = _this.proxyProvider.addProxyElement('navigator', {
                        ...
                        type: 'range',
                        'aria-label': NavigatorComponent_format(handleFormatStr_1, { handleIx: n, chart: chart }, chart)
                    });
        ...
        var performUpdate = function (beforeAnnounce) {
            ...
            if (navigator &&
                ...
                var announceFormatStr = (_a = chart.options.lang
                    .accessibility) === null || _a === void 0 ? void 0 : _a.navigator.changeAnnouncement, axisRangeDescription = NavigatorComponent_getAxisRangeDescription(chart.xAxis[0]);
...
function setPointScreenReaderAttribs(point, pointElement) {
    var _a, _b, _c;
    var series = point.series, seriesPointA11yOptions = ((_a = series.options.accessibility) === null || _a === void 0 ? void 0 : _a.point) || {}, a11yPointOptions = series.chart.options.accessibility.point || {}, label = SeriesDescriber_stripHTMLTags((isString(seriesPointA11yOptions.descriptionFormat) &&
...
function describeSeries(series) {
    var chart = series.chart, firstPointEl = SeriesDescriber_getSeriesFirstPointElement(series), seriesEl = SeriesDescriber_getSeriesA11yElement(series), is3d = chart.is3d && chart.is3d();
    if (seriesEl) {
...
var ProxyElement = /** @class */ (function () {
    ...
    ProxyElement.prototype.click = function () {
        ...
        pos.x += pos.width / 2;
        pos.y += pos.height / 2;
        var fakeEventObject = ProxyElement_getFakeMouseEvent('click', pos);
...
var RangeSelectorComponent = /** @class */ (function (_super) {
    ...
    RangeSelectorComponent.prototype.onInputNavInit = function (direction) {
        ...
        if (svgEl && minInput && maxInput) {
            ...
            var minRemover_1 = RangeSelectorComponent_addEvent(minInput, 'keydown', keydownHandler);
            var maxRemover_1 = RangeSelectorComponent_addEvent(maxInput, 'keydown', keydownHandler);
...
var SeriesKeyboardNavigation = /** @class */ (function () {
    ...
    SeriesKeyboardNavigation.prototype.init = function () {
        var keyboardNavigation = this, chart = this.chart, e = this.eventProvider = new Utils_EventProvider();
    ...
    SeriesKeyboardNavigation.prototype.onDrillupAll = function () {
        var last = this.lastDrilledDownPoint, chart = this.chart, series = last && SeriesKeyboardNavigation_getSeriesFromName(chart, last.seriesName);
        var point;
