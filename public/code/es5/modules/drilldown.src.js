...
function onSeriesAfterDrawDataLabels() {
    ...
    for (var _i = 0, _a = series.points; _i < _a.length; _i++) {
        var point = _a[_i];
        var dataLabelsOptions = point.options.dataLabels, pointCSS = DrilldownSeries_pick(point.dlOptions, dataLabelsOptions && dataLabelsOptions.style, {});
...
var ChartAdditions = /** @class */ (function () {
    ...
    ChartAdditions.prototype.addSeriesAsDrilldown = function (point, options) {
        ...
        if (chart.mapView) {
            ...
            if (chart.options.drilldown &&
                ...
                var userDrilldown = diffObjects(chart.options.drilldown, Drilldown_DrilldownDefaults);
    ...
    ChartAdditions.prototype.fadeInGroup = function (group) {
        var chart = this.chart, animationOptions = Drilldown_animObject(chart.options.drilldown.animation);
        if (group) {
            group.hide();
