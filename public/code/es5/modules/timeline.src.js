...
var TimelineSeries = /** @class */ (function (_super) {
    ...
    TimelineSeries.prototype.alignDataLabel = function (point, dataLabel, _options, _alignTo) {
        ...
        if (point.visible) {
            ...
            if (isInverted) {
                ...
                styles = {
                    width: TimelineSeries_pick((_a = dataLabelsOptions.style) === null || _a === void 0 ? void 0 : _a.width, "".concat(series.yAxis.len * 0.4, "px")),
    ...
    TimelineSeries.prototype.distributeDL = function () {
        ...
        if (dataLabelsOptions) {
            var distance = TimelineSeries_pick(dataLabelsOptions.distance, inverted ? 20 : 100);
    ...
    TimelineSeries.prototype.markerAttribs = function (point, state) {
        var series = this, seriesMarkerOptions = series.options.marker, pointMarkerOptions = point.marker || {}, symbol = (pointMarkerOptions.symbol || seriesMarkerOptions.symbol), width = TimelineSeries_pick(pointMarkerOptions.width, seriesMarkerOptions.width, series.closestPointRangePx), height = TimelineSeries_pick(pointMarkerOptions.height, seriesMarkerOptions.height);
