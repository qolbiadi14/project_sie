...
var DataConverter = /** @class */ (function () {
    ...
    function DataConverter(options) {
        ...
        var mergedOptions = DataConverter_merge(DataConverter.defaultOptions, options);
...
function ABS(args, table) {
    var value = ABS_getArgumentValue(args[0], table);
    switch (typeof value) {
        case 'number':
...
function AVERAGE(args, table) {
    var values = AVERAGE_getArgumentsValues(args, table);
...
function COUNT(args, table) {
    var values = Formula_FormulaProcessor.getArgumentsValues(args, table);
    var count = 0;
    for (var i = 0, iEnd = values.length, value = void 0; i < iEnd; ++i) {
        value = values[i];
        switch (typeof value) {
...
function ISNA(args, table) {
    var value = ISNA_getArgumentValue(args[0], table);
...
function MAX(args, table) {
    var values = MAX_getArgumentsValues(args, table);
...
function MEDIAN(args, table) {
    var median = [], values = Formula_FormulaProcessor.getArgumentsValues(args, table);
    for (var i = 0, iEnd = values.length, value = void 0; i < iEnd; ++i) {
        value = values[i];
        switch (typeof value) {
            case 'number':
...
function MIN(args, table) {
    var values = MIN_getArgumentsValues(args, table);
...
function MOD(args, table) {
    var value1 = MOD_getArgumentValue(args[0], table), value2 = MOD_getArgumentValue(args[1], table);
...
function getModeMap(args, table) {
    var modeMap = {}, values = Formula_FormulaProcessor.getArgumentsValues(args, table);
    for (var i = 0, iEnd = values.length, value = void 0; i < iEnd; ++i) {
        value = values[i];
        switch (typeof value) {
            case 'number':
...
function NOT(args, table) {
    var value = NOT_getArgumentValue(args[0], table);
...
function PRODUCT(args, table) {
    var values = PRODUCT_getArgumentsValues(args, table);
...
var CSVConverter = /** @class */ (function (_super) {
    ...
    function CSVConverter(options) {
        var _this = this;
        var mergedOptions = CSVConverter_merge(CSVConverter.defaultOptions, options);
    ...
    CSVConverter.prototype.parse = function (options, eventDetail) {
        var converter = this, dataTypes = converter.dataTypes, parserOptions = CSVConverter_merge(this.options, options), beforeParse = parserOptions.beforeParse, lineDelimiter = parserOptions.lineDelimiter, firstRowAsNames = parserOptions.firstRowAsNames, itemDelimiter = parserOptions.itemDelimiter;
...
var CSVConnector = /** @class */ (function (_super) {
    ...
    function CSVConnector(options) {
        var _this = this;
        var mergedOptions = CSVConnector_merge(CSVConnector.defaultOptions, options);
        _this = _super.call(this, mergedOptions) || this;
...
var JSONConverter = /** @class */ (function (_super) {
    ...
    function JSONConverter(options) {
        var _this = this;
        var mergedOptions = JSONConverter_merge(JSONConverter.defaultOptions, options);
        _this = _super.call(this, mergedOptions) || this;
        /* *
         *
         *  Properties
...
var JSONConnector = /** @class */ (function (_super) {
    ...
    function JSONConnector(options) {
        var _this = this;
        var mergedOptions = JSONConnector_merge(JSONConnector.defaultOptions, options);
        _this = _super.call(this, mergedOptions) || this;
...
var GoogleSheetsConverter = /** @class */ (function (_super) {
    ...
    function GoogleSheetsConverter(options) {
        var _this = this;
        var mergedOptions = GoogleSheetsConverter_merge(GoogleSheetsConverter.defaultOptions, options);
        _this = _super.call(this, mergedOptions) || this;
        _this.columns = [];
        _this.header = [];
        _this.options = mergedOptions;
    ...
    GoogleSheetsConverter.prototype.parse = function (options, eventDetail) {
        var _a;
        var converter = this, parseOptions = GoogleSheetsConverter_merge(converter.options, options);
...
var GoogleSheetsConnector = /** @class */ (function (_super) {
    ...
    function GoogleSheetsConnector(options) {
        var _this = this;
        var mergedOptions = GoogleSheetsConnector_merge(GoogleSheetsConnector.defaultOptions, options);
        _this = _super.call(this, mergedOptions) || this;
...
var HTMLTableConverter = /** @class */ (function (_super) {
    ...
    function HTMLTableConverter(options) {
        var _this = this;
        var mergedOptions = HTMLTableConverter_merge(HTMLTableConverter.defaultOptions, options);
        _this = _super.call(this, mergedOptions) || this;
        _this.columns = [];
        _this.headers = [];
        _this.options = mergedOptions;
    ...
    HTMLTableConverter.prototype.parse = function (options, eventDetail) {
        var converter = this, columns = [], headers = [], parseOptions = HTMLTableConverter_merge(converter.options, options), endRow = parseOptions.endRow, startColumn = parseOptions.startColumn, endColumn = parseOptions.endColumn, firstRowAsNames = parseOptions.firstRowAsNames, tableHTML = parseOptions.tableElement || this.tableElement;
...
var HTMLTableConnector = /** @class */ (function (_super) {
    ...
    function HTMLTableConnector(options) {
        var _this = this;
        var mergedOptions = HTMLTableConnector_merge(HTMLTableConnector.defaultOptions, options);
        _this = _super.call(this, mergedOptions) || this;
