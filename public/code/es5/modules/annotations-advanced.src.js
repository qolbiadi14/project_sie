...
var BasicAnnotation = /** @class */ (function (_super) {
    ...
    BasicAnnotation.basicControlPoints = {
        ...
        circle: [{
                positioner: function (target) {
                    var xy = Annotations_MockPoint.pointToPixels(target.points[0]), r = target.options.r;
                    return {
...
var CrookedLine = /** @class */ (function (_super) {
    ...
    CrookedLine.prototype.addControlPoints = function () {
        this.getControlPointsOptions().forEach(function (pointOptions, i) {
            var controlPoint = new Annotations_ControlPoint(this.chart, this, CrookedLine_merge(this.options.controlPointOptions, pointOptions.controlPoint), i);
            this.controlPoints.push(controlPoint);
            pointOptions.controlPoint = controlPoint.options;
        }, this);
    };
    CrookedLine.prototype.addShapes = function () {
        var typeOptions = this.options.typeOptions, shape = this.initShape(CrookedLine_merge(typeOptions.line, {
            type: 'path',
 ...
 */
{
    ...
    controlPointOptions: {
        positioner: function (target) {
            var graphic = this.graphic, xy = Annotations_MockPoint.pointToPixels(target.points[this.index]);
            return {
...
var ElliottWave = /** @class */ (function (_super) {
    ...
    ElliottWave.prototype.addLabels = function () {
        ...
        this.getPointsOptions().forEach(function (point, i) {
            var typeOptions = _this.options.typeOptions, label = _this.initLabel(ElliottWave_merge(point.label, {
...
var Tunnel = /** @class */ (function (_super) {
    ...
    Tunnel.prototype.getPointsOptions = function () {
        var pointsOptions = Types_CrookedLine.prototype.getPointsOptions.call(this), yAxisIndex = this.options.typeOptions.yAxis || 0, yAxis = this.chart.yAxis[yAxisIndex];
    ...
    Tunnel.prototype.heightPointOptions = function (pointOptions) {
        var heightPointOptions = Tunnel_merge(pointOptions), typeOptions = this.options.typeOptions;
    ...
    Tunnel.prototype.addControlPoints = function () {
        ...
        var options = this.options, typeOptions = options.typeOptions, controlPoint = new Annotations_ControlPoint(this.chart, this, Tunnel_merge(options.controlPointOptions, typeOptions.heightControlPoint), 2);
        this.controlPoints.push(controlPoint);
 ...
 */
{
    typeOptions: {
        ...
        heightControlPoint: {
            positioner: function (target) {
                var startXY = Annotations_MockPoint.pointToPixels(target.points[2]), endXY = Annotations_MockPoint.pointToPixels(target.points[3]), x = (startXY.x + endXY.x) / 2;
                return {
...
var TimeCycles = /** @class */ (function (_super) {
    ...
    TimeCycles.prototype.addControlPoints = function () {
        ...
        typeOptions.controlPointOptions.forEach(function (option) {
            var controlPointsOptions = TimeCycles_merge(options.controlPointOptions, option);
            var controlPoint = new Annotations_ControlPoint(_this.chart, _this, controlPointsOptions, 0);
...
var Fibonacci = /** @class */ (function (_super) {
    ...
    Fibonacci.prototype.addLabels = function () {
        Fibonacci.levels.forEach(function (level, i) {
            var options = this.options.typeOptions, label = this.initLabel(Fibonacci_merge(options.labels[i], {
                point: function (target) {
...
var FibonacciTimeZones = /** @class */ (function (_super) {
    ...
    FibonacciTimeZones.prototype.addControlPoints = function () {
        var options = this.options, typeOptions = options.typeOptions, controlPoint = new Annotations_ControlPoint(this.chart, this, FibonacciTimeZones_merge(options.controlPointOptions, typeOptions.controlPointOptions), 0);
        this.controlPoints.push(controlPoint);
...
var VerticalLine = /** @class */ (function (_super) {
    ...
    VerticalLine.connectorFirstPoint = function (target) {
        var annotation = target.annotation, chart = annotation.chart, inverted = chart.inverted, point = annotation.points[0], left = VerticalLine_pick(point.series.yAxis && point.series.yAxis.left, 0), top = VerticalLine_pick(point.series.yAxis && point.series.yAxis.top, 0), offset = annotation.options.typeOptions.label.offset, y = Annotations_MockPoint.pointToPixels(point, true)[inverted ? 'x' : 'y'];
        return {
            x: point.x,
            xAxis: point.series.xAxis,
            y: y + offset +
    ...
    VerticalLine.connectorSecondPoint = function (target) {
        var annotation = target.annotation, chart = annotation.chart, inverted = chart.inverted, typeOptions = annotation.options.typeOptions, point = annotation.points[0], left = VerticalLine_pick(point.series.yAxis && point.series.yAxis.left, 0), top = VerticalLine_pick(point.series.yAxis && point.series.yAxis.top, 0), y = Annotations_MockPoint.pointToPixels(point, true)[inverted ? 'x' : 'y'];
    ...
    VerticalLine.prototype.addShapes = function () {
        var typeOptions = this.options.typeOptions, connector = this.initShape(VerticalLine_merge(typeOptions.connector, {
            type: 'path',
            points: [
...
var Measure = /** @class */ (function (_super) {
    ...
    Measure.prototype.addControlPoints = function () {
        ...
        var controlPoint = new Annotations_ControlPoint(this.chart, this, this.options.controlPointOptions, 0);
        this.controlPoints.push(controlPoint);
