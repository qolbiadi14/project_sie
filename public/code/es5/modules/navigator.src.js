...
var StandaloneNavigator = /** @class */ (function () {
    ...
    function StandaloneNavigator(element, userOptions) {
        ...
        var chart = new (highcharts_Chart_commonjs_highcharts_Chart_commonjs2_highcharts_Chart_root_Highcharts_Chart_default())(element, this.chartOptions);
    ...
    StandaloneNavigator.prototype.bind = function (axisOrChart, twoWay) {
        ...
        if (twoWay) {
            var removeSetExtremesEvent = StandaloneNavigator_addEvent(axis, 'setExtremes', function (e) {
                if (e.trigger === 'pan' ||
                    e.trigger === 'zoom' ||
        ...
        var removeSetRangeEvent = StandaloneNavigator_addEvent(this.navigator, 'setRange', function (e) {
