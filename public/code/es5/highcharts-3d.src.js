    ...
    var Additions = /** @class */ (function () {
        ...
        Additions.prototype.get3dFrame = function () {
            var chart = this.chart, options3d = chart.options.chart.options3d, frameOptions = options3d.frame, xm = chart.plotLeft, xp = chart.plotLeft + chart.plotWidth, ym = chart.plotTop, yp = chart.plotTop + chart.plotHeight, zm = 0, zp = options3d.depth, faceOrientation = function (vertexes) {
                var area = Chart3D_shapeArea3D(vertexes, chart);
            ...
            if (options3d.axisLabelPosition === 'auto') {
                ...
                var pickEdge = function (edges, axis, mult) {
                    ...
                    var projections = Chart3D_perspective(edges, chart, false);
                    var best = 0;
...
var Axis3DAdditions = /** @class */ (function () {
    ...
    Axis3DAdditions.prototype.fix3dPosition = function (pos, isTitle) {
        ...
        var alpha = Axis3DComposition_deg2rad * chart.options.chart.options3d.alpha, beta = Axis3DComposition_deg2rad * chart.options.chart.options3d.beta, positionMode = Axis3DComposition_pick(isTitle && axis.options.title.position3d, axis.options.labels.position3d), skew = Axis3DComposition_pick(isTitle && axis.options.title.skew3d, axis.options.labels.skew3d), frame = chart.chart3d.frame3d, plotLeft = chart.plotLeft, plotRight = chart.plotWidth + plotLeft, plotTop = chart.plotTop, plotBottom = chart.plotHeight + plotTop;
        ...
        var projected = Axis3DComposition_perspective([pos], axis.chart)[0];
        if (skew) {
...
var Series3D = /** @class */ (function (_super) {
    ...
    Series3D.prototype.translate3dPoints = function () {
        var series = this, seriesOptions = series.options, chart = series.chart, zAxis = Series3D_pick(series.zAxis, chart.options.zAxis[0]), rawPoints = [], rawPointsX = [], stack = seriesOptions.stacking ?
        ...
        var projectedPoints = Series3D_perspective(rawPoints, chart, true);
...
(function (SVGRenderer3D) {
    ...
    function face3d(args) {
        ...
        ret.attr = function (hash) {
            if (typeof hash === 'object' &&
                ...
                var chart = charts[renderer.chartIndex], vertexes2d = SVGRenderer3D_perspective(this.vertexes, chart, this.insidePlotArea), path = renderer.toLinePath(vertexes2d, true), area = SVGRenderer3D_shapeArea(vertexes2d);
                hash.d = path;
        ...
        ret.animate = function (params) {
            if (typeof params === 'object' &&
                ...
                var chart = charts[renderer.chartIndex], vertexes2d = SVGRenderer3D_perspective(this.vertexes, chart, this.insidePlotArea), path = renderer.toLinePath(vertexes2d, true), area = SVGRenderer3D_shapeArea(vertexes2d), visibility = (this.enabled && area > 0) ?
                    'visible' : 'hidden';
                params.d = path;
    ...
    function arc3d(attribs) {
        ...
        wrapper.animate = function (params, animation, complete) {
            ...
            delete params.z;
            var anim = animObject(SVGRenderer3D_pick(animation, this.renderer.globalAnimation));
            if (anim.duration) {
                var paramArr = extractCustom(params);
                ...
                if (paramArr) {
                    ...
                    interpolate_1 = function (key, pos) { return (from[key] + (SVGRenderer3D_pick(to_1[key], from[key]) -
                        from[key]) * pos); };
...
function wrapSeriesAlignDataLabel(proceed, point, _dataLabel, options, alignTo) {
    ...
    if (chart.is3d() &&
        this.is('column')) {
        var series = this, seriesOptions = series.options, inside = Column3DComposition_pick(options.inside, !!series.options.stacking), options3d = chart.options.chart.options3d, xOffset = point.pointWidth / 2 || 0;
        var dLPosition = {
            x: alignTo.x + xOffset,
            y: alignTo.y,
    ...
    Pie3DSeries.prototype.getDataLabelPosition = function (point, distance) {
        ...
        if (this.chart.is3d()) {
            ...
            a1 = ((shapeArgs.alpha || (options3d === null || options3d === void 0 ? void 0 : options3d.alpha)) *
                Pie3DSeries_deg2rad), b1 = ((shapeArgs.beta || (options3d === null || options3d === void 0 ? void 0 : options3d.beta)) *
