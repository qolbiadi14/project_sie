...
var SMAIndicator = /** @class */ (function (_super) {
    ...
    SMAIndicator.prototype.init = function (chart, options) {
        ...
        var linkedSeriesUnbiner = addEvent((highcharts_Chart_commonjs_highcharts_Chart_commonjs2_highcharts_Chart_root_Highcharts_Chart_default()), 'afterLinkSeries', function (_a) {
...
function accumulatePoints(sum, yVal, i, index, subtract) {
    var price = DPOIndicator_pick(yVal[i][index], yVal[i]);
    if (subtract) {
...
var ChaikinIndicator = /** @class */ (function (_super) {
    ...
    ChaikinIndicator.prototype.getValues = function (series, params) {
        ...
        var ADL = AD_ADIndicator.prototype.getValues.call(this, series, {
...
var KlingerIndicator = /** @class */ (function (_super) {
    ...
    KlingerIndicator.prototype.isValidData = function (firstYVal) {
        var chart = this.chart, options = this.options, series = this.linkedParent, isSeriesOHLC = KlingerIndicator_isArray(firstYVal) &&
...
var MACDIndicator = /** @class */ (function (_super) {
    ...
    MACDIndicator.prototype.drawGraph = function () {
        ...
        ['macd', 'signal'].forEach(function (lineName, i) {
            ...
            indicator.options = MACDIndicator_merge(((_a = mainLineOptions["".concat(lineName, "Line")]) === null || _a === void 0 ? void 0 : _a.styles) || {}, gappedExtend);
...
var OBVIndicator = /** @class */ (function (_super) {
    ...
    OBVIndicator.prototype.getValues = function (series, params) {
        var volumeSeries = series.chart.get(params.volumeSeriesID), xVal = series.xData, yVal = series.yData, OBV = [], xData = [], yData = [], hasOHLC = !OBVIndicator_isNumber(yVal[0]);
...
var SupertrendIndicator = /** @class */ (function (_super) {
    ...
    SupertrendIndicator.prototype.init = function () {
        ...
        var unbinder = SupertrendIndicator_addEvent(this.chart.constructor, 'afterLinkSeries', function () {
...
var VBPIndicator = /** @class */ (function (_super) {
    ...
    VBPIndicator.prototype.init = function (chart, options) {
        ...
        _super.prototype.init.apply(indicator, arguments);
        // Only after series are linked add some additional logic/properties.
        var unbinder = VBPIndicator_addEvent(this.chart.constructor, 'afterLinkSeries', function () {
            // Protection for a case where the indicator is being updated,
            // for a brief moment the indicator is deleted.
            if (indicator.options) {
